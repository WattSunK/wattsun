/* WattSun Admin — Single Partial Loader (sequential script exec) */
(() => {
  ...
  async function executeInlineScripts(scope) {
    ...
    for (const old of scripts) {
      ...
      if (old.src || s.getAttribute("src")) {
        ...
        old.parentNode.replaceChild(s, s);
      }
    }
  }
  ...
  async function loadPartial(id, url) {
    ...
    try {
      ...
      await executeInlineScripts(contentEl);
